    ...
    return function() {
                ...
                729: function(e) {
                    ...
                    Object.create && (r.prototype = Object.create(null), (new r).__proto__ || (n = !1)), s.prototype.eventNames = function() {
                        ...
                        if (c.fn) {
                            ...
                            var d, f = c.length;
                            for (u = 0; u < f; u++) switch (c[u].once && this.removeListener(e, c[u].fn, void 0, !0), p) {
                                case 1:
                        ...
                        if (s.fn) s.fn !== t || o && !s.once || r && s.context !== r || a(this, i);
                            ...
                            for (var l = 0, u = [], c = s.length; l < c; l++)(s[l].fn !== t || o && !s[l].once || r && s[l].context !== r) && u.push(s[l]);
                    ...
                    */
                    ...
                    e.exports = function() {
                        ...
                        for (var a, s, l = o(e), u = 1; u < arguments.length; u++) {
                            ...
                            if (t) {
                                s = t(a);
                                for (var p = 0; p < s.length; p++) r.call(a, s[p]) && (l[s[p]] = a[s[p]])
                            }
                        }
                        return l
                    }
        ...
        return function() {
            ...
            ***************************************************************************** */
            ...
            function(e) {
                e.AUTHENTICATE = "authenticate", e.VIDEO_READY = "video.ready", e.VIDEO_PLAY = "video.play", e.VIDEO_PAUSE = "video.pause", e.CAPTIONS = "captions", e.ENDED = "ended", e.ERROR = "error", e.ONLINE = "online", e.OFFLINE = "offline", e.PAUSE = "pause", e.PLAY = "play", e.PLAYBACK_BLOCKED = "playbackBlocked", e.PLAYING = "playing", e.READY = "ready", e.SEEK = "seek"
            }(s || (s = {})),
            function(e) {
            ...
            function g(e, t) {
                var n = m.Pz(o(o({}, e), {
                    ...
                    }.IS_DEV_BUILD ? function(e, t, n) {
                        if (!t) return "https://localhost.twitch.tech:8080/";
                        var r = e.replace(/"/g, "");
                        return isNaN(parseInt(r, 10)) ? "https://" + n + "-" + r + ".twitch.tech" : "https://" + n + "-pr" + parseInt(r, 10) + ".twitch.tech"
                    }('"main"', !0, t) : "https://" + t + ".twitch.tv") + "?" + n,
                    i = document.createElement("iframe");
                i.setAttribute("src", r), i.setAttribute("allowfullscreen", ""), i.setAttribute("scrolling", "no"), i.setAttribute("frameborder", "0"), i.setAttribute("allow", "autoplay; fullscreen"), i.setAttribute("title", "Twitch");
                var a = "allow-modals allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox";
                return "function" == typeof document.hasStorageAccess && "function" == typeof document.requestStorageAccess && (a += " allow-storage-access-by-user-activation"), i.setAttribute("sandbox", a), e.width && i.setAttribute("width", String(e.width)), e.height && i.setAttribute("height", String(e.height)), i
            }
            ...
            var _ = {
                ...
                E = function(e) {
                    function n() {
                        ...
                        return t._embedWindow = null, t._playerState = _, window.addEventListener("message", t._handleResponses.bind(t)), t
                    }
                    return t(n, e), n.prototype._setWindowRef = function(e) {
                        this._embedWindow = e
                ...
                P = function(e) {
                    function n(t, n) {
                        ...
                        return r._options = {}, r._target = null, r._player = new E, r._eventEmitter = null, r._iframe = null, r._forwardEmbedEvents = function(e) {
                                if (r._iframe) {
                                    var t = e.data,
                            ...
                            function(e) {
                                ...
                                return t
                            }(t), r._eventEmitter = new u, r.render(), r
                    }
                    return t(n, e), n.prototype.addEventListener = function(e, t) {
                    ...
                    }, n.AUTHENTICATE = s.AUTHENTICATE, n.CAPTIONS = s.CAPTIONS, n.ENDED = s.ENDED, n.ERROR = s.ERROR, n.OFFLINE = s.OFFLINE, n.ONLINE = s.ONLINE, n.PAUSE = s.PAUSE, n.PLAY = s.PLAY, n.PLAYBACK_BLOCKED = s.PLAYBACK_BLOCKED, n.PLAYING = s.PLAYING, n.VIDEO_PAUSE = s.VIDEO_PAUSE, n.VIDEO_PLAY = s.VIDEO_PLAY, n.VIDEO_READY = s.VIDEO_READY, n.READY = s.READY, n.SEEK = s.SEEK, n.Errors = o({
                        ABORTED: p.Aborted,
                        NETWORK: p.Network,
                        DECODE: p.Decode,
            ...
            var C = {
                ...
                Player: function(e) {
                    ...
                    return t(n, e), n.prototype.buildIframe = function() {
